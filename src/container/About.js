...
import { BsCode, BsPen, BsPenFill } from 'react-icons/bs';
    ...
    constructor(props) {
        ...
        this.state = {
            aboutCard: [
                ...
                { id: 4, count: 0, title: 'Journal writer', titleIcon: <BsPen />, des: 'Where I share my mini journals', icon: <DiOpenshift />, isHighlight: false },
            ],
                ...
                <div className='about-div'>
                    ...
                    <div className='col' style={{ flex: 3, gap: '25px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '7px' }}>
                            ...
                            <button className='row btn-home' style={{ gap: '16px' }} onClick={this.openJournal}>
                                <div>{Constant.journal}</div>
                                <div className='center'><BsPen /></div>
                            </button>
                        </div>
                    </div>
                    <div style={{ flex: 3 }}>
                ...
                <div style={{ display: 'flex', }}>
                    ...
                    <div className='about-card-div' style={{ flex: 6, gap: '12px' }}>
                        {this.state.aboutCard?.map(i =>
                            <div className='about-card col' style={{ gap: '5px ', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
